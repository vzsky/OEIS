...
private:
  ...
  void split(node_ptr &l, node_ptr &r, node_ptr &&t,
             value_type val) const { // <= val in l
    if (!t) {
      l = nullptr;
      r = nullptr;
      return;
  ...
  void splitat(node_ptr &l, node_ptr &r, node_ptr &&t,
               size_type pos) const { // first pos elements at l
    if (!t) {
      l = nullptr;
      r = nullptr;
      return;
...
//   std::cout << t << std::endl;
//
//   std::cout << t.contains(1) << std::endl;
